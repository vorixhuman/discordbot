...
class PaginationView(discord.ui.View):
    ...
    @discord.ui.button(emoji="<:MekoDoubleArrowLeft:1449451388252721184>", style=discord.ButtonStyle.blurple, disabled=False)
    async def first(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.current = 0
    ...
    @discord.ui.button(emoji="<:MekoArrowLeft:1449451394305233029> ", style=discord.ButtonStyle.green, disabled=False)
    async def previous(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ):
    ...
    @discord.ui.button(emoji="<:MekoTrash:1449445909585723454>", style=discord.ButtonStyle.red)
    async def stop(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.message.delete()
        self.stop()

    @discord.ui.button(emoji="<:MekoArrowRight:1449445989436887090>", style=discord.ButtonStyle.green, disabled=False)
    async def next(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.current += 1
    ...
    @discord.ui.button(emoji="<:MekoDoubleArrowRight:1449451401024372841>", style=discord.ButtonStyle.blurple, disabled=False)
