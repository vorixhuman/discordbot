...
class Welcomer(commands.Cog):
    ...
    async def greet_setup(self, ctx):
        ...
        embed.add_field(
            name="<:MekoArrowRight:1449445989436887090> Simple",
            value="Send a plain text welcome message. You can use placeholders to personalize it.\n\n",
            inline=False
        )
        embed.add_field(
            name="<:MekoArrowRight:1449445989436887090> Embed",
    ...
    async def simple_setup(self, ctx):
        ...
        async def submit_callback(interaction):
            ...
            if message_content:
                ...
                await interaction.response.send_message("<a:H_TICK:1449446011490537603> Welcome message setup completed!")
        ...
        cancel_button = Button(emoji="<:MekoTrash:1449445909585723454>", style=discord.ButtonStyle.secondary)
    ...
    color=discord.Color(embed_data["color"]) if embed_data["color"] else discord.Color(0x2f3136)
        ...
        async def submit_callback(interaction):
            ...
            await interaction.response.send_message("<a:H_TICK:1449446011490537603> Embed welcome message setup completed!")
    ...
    async def greet_reset(self, ctx):
        ...
        async def yes_button_callback(interaction):
            ...
            embed.title = "<a:H_TICK:1449446011490537603>Success"
    ...
    async def greet_channel(self, ctx):
        ...
        def generate_view(page):
            select_menu = Select(
                ...
                options=[
                    discord.SelectOption(label=channel.name, emoji="<:MekoChannel:1449446152108904509>", value=str(channel.id))
            ...
            async def select_callback(interaction: discord.Interaction):
                ...
                await ctx.send(f"<a:H_TICK:1449446011490537603> Welcome channel has been set to {selected_channel.mention}")
    ...
    async def greet_autodelete(self, ctx, time: str):
        ...
        await ctx.send(f"<a:H_TICK:1449446011490537603> Auto delete duration has been set to **{auto_delete_duration}** seconds.")
